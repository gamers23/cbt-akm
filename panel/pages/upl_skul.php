...
//apabila terjadi event onchange terhadap object <select id=propinsi>
 ...
 var txt_nm_ujian = $("#txt_nm_ujian").val();
 ...
 $.ajax({
	 ...
	 "&txt_nip1=" + txt_nip1 + "&txt_nip2=" + txt_nip2 + "&txt_prop=" + txt_prop + "&txt_kab=" + txt_kab + "&txt_kec=" + txt_kec + "&txt_h1=" + txt_h1 + "&txt_h2=" + txt_h2 + "&txt_h3=" + txt_h3 + "&txt_nm_ujian=" + txt_nm_ujian + "&txt_code=" + txt_code,
    ...
    <div class="right">
    			<div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <tr height="42px"><td>Nama Ujian </td><td>: <td><input class="form-control" type="text" id="txt_nm_ujian" value="<?php echo "$nm_ujian"; ?>" /></td></tr>
                            <tr height="42px"><td>Kode Aplikasi </td><td>: <td><input class="form-control" type="text" id="txt_code" value="<?php echo "$code"; ?>" /></td></tr>
