...
?>
<table style="width:100%;border:1px solid ; padding:55px; font-family:Arial, Helvetica, sans-serif; font-size:12px" class="kartu" border="0">
					<tbody>
                    <tr>
			...
			<tr><td width="115">&nbsp;Nama Peserta</td><td width="1"></td><td><?php echo ": $a[XNamaSiswa] "; ?></td></tr>
					...
					<tr><td rowspan="3" align="center"><img src="../../fotosiswa/<?php echo $pic; ?>" height="75px" border="thin solid red"></td>
