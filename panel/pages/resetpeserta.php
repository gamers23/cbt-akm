                        ...
                        data-row-select="true" data-keep-selection="true">
                            <thead>
                                <tr style="background-color:#e7e7e7">
                                    <th data-column-id="id" data-identifier="true" data-type="numeric" data-align="left">No</th>
                                    <th data-column-id="nomer" data-align="left" data-header-align="left" data-width="7%" 
                                    data-filterable="true">No</th>
                                    <th data-align="left" data-header-align="center" data-width="10%" 
                                    ...
                                    <th data-column-id="nisn" data-css-class="cell" data-header-css-class="column" data-filterable="true" data-width="9%" >NISN</th>                                    <th data-column-id="kelas" data-css-class="cell" data-header-css-class="column" data-filterable="true" data-width="7%" >Kelas</th>                                    <th data-column-id="jurusan" data-css-class="cell" data-header-css-class="column" data-filterable="true" data-width="8%" >Jurusan</th>                                    <th data-column-id="mapel" data-css-class="cell" data-header-css-class="column" data-filterable="true" data-width="20%" >Mapel</th>
...
if(isset($_REQUEST['token'])){
        ...
        where u.XStatusUjian = '1' and su.XTokenUjian = '$_REQUEST[token]'");
        $nom = 1;
