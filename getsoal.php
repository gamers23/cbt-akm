...
<div class="kakisoal" id="kakisoal" style="padding-left:100px; align-items: center;">
	<section class="page-section soal-navigation">
		<div class="container1" style="margin-right:-100px; margin-left:-50px;">
			<div >
				 <?php 	if($prev_id>0){ 
					echo "<a href='#' data-id='".$prev_id."' class='get_pic' id='tombol'>"; } ?>
						<button id="btnPrevSoal" style="padding-bottom:10px; padding-top:10px; width:60%; border-radius: 30px;font-size: 16px; font-family: arial;" class="btn btn-primary btn-prev" data-bind="click: gotoBack">Soal Sebelumnya</button>
					</a>
			</div>
			<?php	if(isset($stu)){ 
			...
			?>
			<div>	<label  class="labele" style="padding-bottom:10px; padding-top:10px; width:60%; border-radius: 30px;">
			...
			<div >
					...
					<?php 	$cekragu = mysqli_num_rows(mysqli_query($sqlconn,"select * from cbt_jawaban where XRagu ='1' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'  and XUserJawab = '$user'")); 
							if($cekragu>0){ ?>
							<button id="btnSelesai" style="padding-bottom:10px; padding-top:10px; width:60%; border-radius: 30px;" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModalR">TES SELESAI</button>
					<?php 	} else { ?>  
							<button id="btnSelesai" style="padding-bottom:10px; padding-top:10px; width:60%; border-radius: 30px;" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModal2">TES SELESAI</button>
					<?php 	} echo "</a>";
								...
								<button id="btnNextSoal" class="btn btn-primary btn-next activebutton" data-bind="css: { &#39;activebutton&#39;:(currentNo() &lt; totalQuestions - 1)}, visible: (currentNo() &lt; 
									totalQuestions - 1),click: gotoNext" style="padding-bottom:10px; padding-top:10px; width:60%; border-radius: 30px;font-size: 16px; font-family: arial;">Soal Selanjutnya</button>
					<?php  	} ?>
					<?php 	} else { ?>
			 		<?php	$cekragu = mysqli_num_rows(mysqli_query($sqlconn,"select * from cbt_jawaban where XRagu ='1' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'  and XUserJawab = '$user'")); 
							if($cekragu>0){ ?>
								<button id="btnSelesai" style="padding-bottom:10px; padding-top:10px; width:60%;border-radius: 30px;font-size: 16px; font-family: arial;" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModalR">TES SELESAI</button>
							<?php } else { ?>  
								<button id="btnSelesai" style="padding-bottom:10px; padding-top:10px; width:60%; border-radius: 30px;font-size: 16px; font-family: arial;" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModal2">TES SELESAI</button>
							<?php } echo "</a>";  }?>
			</div>
		</div>
	</section>	
...
<style>
	.labele { display: block; padding-top:6px; padding-bottom:6px; font-size: 16px; background-color: #eaca08; margin-top:-10px; padding-left:50px;
			border-radius: 2px; cursor:pointer; width:210px; color:#8b0000;  
...
<div class="modal fade" id="myModal2" role="dialog">
    <div class="container-fluid sm-width" style="padding-top: 20px;">
		<div class="panel panel-default">
			<div class="panel-heading">
			...
			<div class="panel-body">
				<div class="inner-content">
					<div class="row" style="background-color:#fff">
						...
						<div class="col-xs-9 glyphicon-left-panel">
						...
						<div class="assent-checkbox" style="padding-left: 20px;">
			...
			<div class="panel-footer">
				...
				<div class="row" >
					<div class="col-xs-6"> 
						<button id="btnLanjut" type="submit" class="btn btn-primary btn-block" disabled onClick="location.href='akhir.php';"  style="border-radius: 30px;font-family: arial;">SELESAI</button>
					</div>
					<div class="col-xs-6" >
						<button type="submit" class="btn btn-danger btn-block " data-dismiss="modal" style="border-radius: 30px;font-family: arial;">TIDAK</button>
					</div>
				</div>
			</div>
                ...
                <div class="panel-footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-center" style="margin-left:25%; border-radius: 30px;" >
                            ...
                            <button data-bind="click: handleNotConfirm" type="submit" class="btn btn-danger btn-block"  data-dismiss="modal" id="lanjut">LANJUT</button>
                        </div>
                    </div>
                </div>
