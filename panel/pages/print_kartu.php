...
include "../../config/server.php";
	$sqlam = mysqli_query($sqlconn,"select * from (select * from cbt_siswa where XKodeKelas = '$kokel' and XKodeJurusan='$kojur' order by Urut  limit $am) as ambil order by Urut Desc limit 1");
                    ...
                    <tr>
						<td colspan="4" style="padding:1px" align="center">
							...
							<tbody><tr>
								...
								<font color="#" >KARTU PESERTA <br> <?php echo $nama_uji; ?>  <br>
	...
	$cekQuery = mysqli_query($sqlconn,"SELECT * FROM cbt_siswa where XKodeKelas = '$_REQUEST[kelas]' and  XKodeJurusan = '$_REQUEST[jur]' ");
	} else {
