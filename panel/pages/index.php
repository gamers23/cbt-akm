...
<head>
	<link href='../../images/daffa.png' rel='icon' type='image/gif'/>
    <meta charset="utf-8">
...
<header>
	<nav class="navbar navbar-default" >
			<div class="navbar-header" style="width:100%;  background-color:<?php echo $skul_warna; ?>;" >
				<a class="navbar-header"><img alt="Brand" src="../../images/<?php echo $skul_ban; ?>"; width="70%" height="70%" style="padding-top: 5px; padding-left: 5px;"></a>
				<ul class="nav navbar-nav navbar-right">
					<li class="nav" >
						...
						<?php }else{?>
							<img src="photo/<?php echo "$gambar"; ?>" style="margin-top:0px; height:30px; overflow:hidden; border-radius: 50px;"> &nbsp; <?php echo $ucap." : ".$nama; ?>&nbsp;&nbsp;<span class="caret"></span></a>
						<?php } ?>
...
<div id="headtop"  style="width:98%; margin:15px 15px 1px 15px; height:60px; background-color:#fff; border-bottom-color:#fff; font-size:20px; padding:15px;">
...
<div id="headtop"  style="width:98%; margin:0px 15px 15px 15px; height:60px; background-color:#fffefb; 
	border-bottom-color:#e4e4e2; font-size:14px; padding:15px; text-align:center"><span style="color: #ff0000;"><?php echo strtoupper($skull); ?> </span>| <span style="color: #1B06CF;">by DAFFAMEDIA</span>
</div>
